...
type ComplexityRoot struct {
	...
	MemberCountsWithMemberDetailsByChatRoom struct {
	...
	Mutation struct {
		...
		NewPrivateChatRoom                 func(childComplexity int, input model.NewPrivateChatRoom) int
		NewGroupchatRoom                   func(childComplexity int, input model.NewGroupChatRoom) int
		NewChatRoomMembers                 func(childComplexity int, input model.NewChatRoomMembers) int
		...
		DeleteChatRoomPermenantly          func(childComplexity int, input *model.RemoveChatRoomPermenantly) int
		RemoveMembersFromChatRoomByCreator func(childComplexity int, input *model.RemoveMembersFromChatRoom) int
...
type MutationResolver interface {
	...
	NewPrivateChatRoom(ctx context.Context, input model.NewPrivateChatRoom) (model.ChatRoom, error)
	NewGroupchatRoom(ctx context.Context, input model.NewGroupChatRoom) (model.ChatRoom, error)
	NewChatRoomMembers(ctx context.Context, input model.NewChatRoomMembers) (bool, error)
...
func field_Mutation_newPrivateChatRoom_args(rawArgs map[string]interface{}) (map[string]interface{}, error) {
	args := map[string]interface{}{}
	var arg0 model.NewPrivateChatRoom
	if tmp, ok := rawArgs["input"]; ok {
		var err error
		arg0, err = UnmarshalNewPrivateChatRoom(tmp)
		if err != nil {
			return nil, err
		}
	}
...
func field_Mutation_newGroupchatRoom_args(rawArgs map[string]interface{}) (map[string]interface{}, error) {
	args := map[string]interface{}{}
	var arg0 model.NewGroupChatRoom
	if tmp, ok := rawArgs["input"]; ok {
		var err error
		arg0, err = UnmarshalNewGroupChatRoom(tmp)
		if err != nil {
			return nil, err
		}
	}
...
func field_Mutation_newChatRoomMembers_args(rawArgs map[string]interface{}) (map[string]interface{}, error) {
	args := map[string]interface{}{}
	var arg0 model.NewChatRoomMembers
	if tmp, ok := rawArgs["input"]; ok {
		var err error
		arg0, err = UnmarshalNewChatRoomMembers(tmp)
		if err != nil {
			return nil, err
		}
	}
...
func field_Mutation_deleteChatRoomPermenantly_args(rawArgs map[string]interface{}) (map[string]interface{}, error) {
	args := map[string]interface{}{}
	var arg0 *model.RemoveChatRoomPermenantly
	if tmp, ok := rawArgs["input"]; ok {
		var err error
		var ptr1 model.RemoveChatRoomPermenantly
		if tmp != nil {
			ptr1, err = UnmarshalRemoveChatRoomPermenantly(tmp)
			arg0 = &ptr1
		}
...
func field_Mutation_removeMembersFromChatRoomByCreator_args(rawArgs map[string]interface{}) (map[string]interface{}, error) {
	args := map[string]interface{}{}
	var arg0 *model.RemoveMembersFromChatRoom
	if tmp, ok := rawArgs["input"]; ok {
		var err error
		var ptr1 model.RemoveMembersFromChatRoom
		if tmp != nil {
			ptr1, err = UnmarshalRemoveMembersFromChatRoom(tmp)
			arg0 = &ptr1
		}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "MemberCountsWithMemberDetailsByChatRoom.memberCount":
		if e.complexity.MemberCountsWithMemberDetailsByChatRoom.MemberCount == nil {
			break
		}

		return e.complexity.MemberCountsWithMemberDetailsByChatRoom.MemberCount(childComplexity), true

	case "MemberCountsWithMemberDetailsByChatRoom.members":
		if e.complexity.MemberCountsWithMemberDetailsByChatRoom.Members == nil {
			break
		}

		return e.complexity.MemberCountsWithMemberDetailsByChatRoom.Members(childComplexity), true
	...
	case "Mutation.newPrivateChatRoom":
		if e.complexity.Mutation.NewPrivateChatRoom == nil {
			break
		}

		args, err := field_Mutation_newPrivateChatRoom_args(rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Mutation.NewPrivateChatRoom(childComplexity, args["input"].(model.NewPrivateChatRoom)), true

	case "Mutation.newGroupchatRoom":
		if e.complexity.Mutation.NewGroupchatRoom == nil {
			break
		}

		args, err := field_Mutation_newGroupchatRoom_args(rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Mutation.NewGroupchatRoom(childComplexity, args["input"].(model.NewGroupChatRoom)), true

	case "Mutation.newChatRoomMembers":
		if e.complexity.Mutation.NewChatRoomMembers == nil {
			break
		}

		args, err := field_Mutation_newChatRoomMembers_args(rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Mutation.NewChatRoomMembers(childComplexity, args["input"].(model.NewChatRoomMembers)), true
	...
	case "Mutation.deleteChatRoomPermenantly":
		if e.complexity.Mutation.DeleteChatRoomPermenantly == nil {
			break
		}

		args, err := field_Mutation_deleteChatRoomPermenantly_args(rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Mutation.DeleteChatRoomPermenantly(childComplexity, args["input"].(*model.RemoveChatRoomPermenantly)), true

	case "Mutation.removeMembersFromChatRoomByCreator":
		if e.complexity.Mutation.RemoveMembersFromChatRoomByCreator == nil {
			break
		}

		args, err := field_Mutation_removeMembersFromChatRoomByCreator_args(rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Mutation.RemoveMembersFromChatRoomByCreator(childComplexity, args["input"].(*model.RemoveMembersFromChatRoom)), true
...
var memberCountsWithMemberDetailsByChatRoomImplementors = []string{"MemberCountsWithMemberDetailsByChatRoom"}

// nolint: gocyclo, errcheck, gas, goconst
func (ec *executionContext) _MemberCountsWithMemberDetailsByChatRoom(ctx context.Context, sel ast.SelectionSet, obj *model.MemberCountsWithMemberDetailsByChatRoom) graphql.Marshaler {
	fields := graphql.CollectFields(ctx, sel, memberCountsWithMemberDetailsByChatRoomImplementors)
	...
	for i, field := range fields {
		...
		switch field.Name {
		case "__typename":
			out.Values[i] = graphql.MarshalString("MemberCountsWithMemberDetailsByChatRoom")
		case "memberCount":
			out.Values[i] = ec._MemberCountsWithMemberDetailsByChatRoom_memberCount(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalid = true
			}
		case "members":
			out.Values[i] = ec._MemberCountsWithMemberDetailsByChatRoom_members(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				invalid = true
			}
		default:
...
// nolint: vetshadow
func (ec *executionContext) _MemberCountsWithMemberDetailsByChatRoom_memberCount(ctx context.Context, field graphql.CollectedField, obj *model.MemberCountsWithMemberDetailsByChatRoom) graphql.Marshaler {
	rctx := &graphql.ResolverContext{
		Object: "MemberCountsWithMemberDetailsByChatRoom",
		Args:   nil,
		Field:  field,
	}
	ctx = graphql.WithResolverContext(ctx, rctx)
...
// nolint: vetshadow
func (ec *executionContext) _MemberCountsWithMemberDetailsByChatRoom_members(ctx context.Context, field graphql.CollectedField, obj *model.MemberCountsWithMemberDetailsByChatRoom) graphql.Marshaler {
	rctx := &graphql.ResolverContext{
		Object: "MemberCountsWithMemberDetailsByChatRoom",
		Args:   nil,
		Field:  field,
...
func (ec *executionContext) _Mutation(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "newPrivateChatRoom":
			out.Values[i] = ec._Mutation_newPrivateChatRoom(ctx, field)
			if out.Values[i] == graphql.Null {
				invalid = true
			}
		case "newGroupchatRoom":
			out.Values[i] = ec._Mutation_newGroupchatRoom(ctx, field)
			if out.Values[i] == graphql.Null {
				invalid = true
			}
		case "newChatRoomMembers":
			out.Values[i] = ec._Mutation_newChatRoomMembers(ctx, field)
			if out.Values[i] == graphql.Null {
				invalid = true
			}
		case "newMessage":
		...
		case "deleteChatRoomPermenantly":
			out.Values[i] = ec._Mutation_deleteChatRoomPermenantly(ctx, field)
			if out.Values[i] == graphql.Null {
				invalid = true
			}
		case "removeMembersFromChatRoomByCreator":
			out.Values[i] = ec._Mutation_removeMembersFromChatRoomByCreator(ctx, field)
			if out.Values[i] == graphql.Null {
				invalid = true
			}
		case "leaveChatRoom":
...
// nolint: vetshadow
func (ec *executionContext) _Mutation_newPrivateChatRoom(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	rawArgs := field.ArgumentMap(ec.Variables)
	args, err := field_Mutation_newPrivateChatRoom_args(rawArgs)
	if err != nil {
		ec.Error(ctx, err)
	...
	resTmp := ec.FieldMiddleware(ctx, nil, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().NewPrivateChatRoom(rctx, args["input"].(model.NewPrivateChatRoom))
	})
	if resTmp == nil {
		if !ec.HasError(rctx) {
			ec.Errorf(ctx, "must not be null")
...
// nolint: vetshadow
func (ec *executionContext) _Mutation_newGroupchatRoom(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	rawArgs := field.ArgumentMap(ec.Variables)
	args, err := field_Mutation_newGroupchatRoom_args(rawArgs)
	if err != nil {
		ec.Error(ctx, err)
	...
	resTmp := ec.FieldMiddleware(ctx, nil, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().NewGroupchatRoom(rctx, args["input"].(model.NewGroupChatRoom))
	})
	if resTmp == nil {
		if !ec.HasError(rctx) {
			ec.Errorf(ctx, "must not be null")
...
// nolint: vetshadow
func (ec *executionContext) _Mutation_newChatRoomMembers(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	rawArgs := field.ArgumentMap(ec.Variables)
	args, err := field_Mutation_newChatRoomMembers_args(rawArgs)
	if err != nil {
		ec.Error(ctx, err)
	...
	resTmp := ec.FieldMiddleware(ctx, nil, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().NewChatRoomMembers(rctx, args["input"].(model.NewChatRoomMembers))
	})
	if resTmp == nil {
		if !ec.HasError(rctx) {
			ec.Errorf(ctx, "must not be null")
...
// nolint: vetshadow
func (ec *executionContext) _Mutation_deleteChatRoomPermenantly(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	rawArgs := field.ArgumentMap(ec.Variables)
	args, err := field_Mutation_deleteChatRoomPermenantly_args(rawArgs)
	if err != nil {
		ec.Error(ctx, err)
	...
	resTmp := ec.FieldMiddleware(ctx, nil, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().DeleteChatRoomPermenantly(rctx, args["input"].(*model.RemoveChatRoomPermenantly))
	})
	if resTmp == nil {
		if !ec.HasError(rctx) {
			ec.Errorf(ctx, "must not be null")
...
// nolint: vetshadow
func (ec *executionContext) _Mutation_removeMembersFromChatRoomByCreator(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	rawArgs := field.ArgumentMap(ec.Variables)
	args, err := field_Mutation_removeMembersFromChatRoomByCreator_args(rawArgs)
	if err != nil {
		ec.Error(ctx, err)
	...
	resTmp := ec.FieldMiddleware(ctx, nil, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().RemoveMembersFromChatRoomByCreator(rctx, args["input"].(*model.RemoveMembersFromChatRoom))
	})
	if resTmp == nil {
		if !ec.HasError(rctx) {
			ec.Errorf(ctx, "must not be null")
...
func (ec *executionContext) _Query_memberListByChatRoomId(ctx context.Context, field graphql.CollectedField) graphql.Marshaler {
	...
	res := resTmp.(model.MemberCountsWithMemberDetailsByChatRoom)
	rctx.Result = res

	return ec._MemberCountsWithMemberDetailsByChatRoom(ctx, field.Selections, &res)
}
...
func UnmarshalNewChatRoomMembers(v interface{}) (model.NewChatRoomMembers, error) {
	var it model.NewChatRoomMembers
	var asMap = v.(map[string]interface{})
	...
	for k, v := range asMap {
		...
		case "memberIDs":
			...
			it.MemberIDs = make([]int, len(rawIf1))
			for idx1 := range rawIf1 {
				it.MemberIDs[idx1], err = model.UnmarshalID(rawIf1[idx1])
			}
			if err != nil {
				return it, err
			}
...
func UnmarshalNewGroupChatRoom(v interface{}) (model.NewGroupChatRoom, error) {
	var it model.NewGroupChatRoom
	var asMap = v.(map[string]interface{})
	...
	for k, v := range asMap {
		...
		case "chatRoomName":
			var err error
			it.ChatRoomName, err = graphql.UnmarshalString(v)
			if err != nil {
				return it, err
			}
		case "chatRoomType":
...
func UnmarshalNewPrivateChatRoom(v interface{}) (model.NewPrivateChatRoom, error) {
	var it model.NewPrivateChatRoom
	var asMap = v.(map[string]interface{})
	...
	for k, v := range asMap {
		...
		case "receiverID":
			var err error
			it.ReceiverID, err = model.UnmarshalID(v)
			if err != nil {
				return it, err
			}
		}
...
func UnmarshalRemoveChatRoomPermenantly(v interface{}) (model.RemoveChatRoomPermenantly, error) {
	var it model.RemoveChatRoomPermenantly
	var asMap = v.(map[string]interface{})
	...
	for k, v := range asMap {
		...
		case "creator":
			var err error
			it.Creator, err = model.UnmarshalID(v)
			if err != nil {
				return it, err
			}
		}
...
func UnmarshalRemoveMembersFromChatRoom(v interface{}) (model.RemoveMembersFromChatRoom, error) {
	var it model.RemoveMembersFromChatRoom
	var asMap = v.(map[string]interface{})
